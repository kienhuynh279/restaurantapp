      ...
      <div className="w-full h-full bg-cartBg rounded-t-[2em] flex flex-col">
        ...
        <div className="w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
          ...
          <div className="w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/restaurantapp-5be67.appspot.com/o/image%2F1650023838901-f5.png?alt=media&token=bee71bf6-72a6-42b8-b183-b25a8a54087b"
              alt=""
            ...
            <div className="flex flex-col gap-2">
              <p className="text-base text-gray-50">Dâu tây</p>
